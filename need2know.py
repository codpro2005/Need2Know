...
class ScraperHelper():
    ...
    @staticmethod
    def do_until_action(do_while_not_valid_action, *args):
    ...
    @staticmethod
    def do_until_no_exception(check_no_exception_action, *args):
        ...
        ScraperHelper.do_until_action(do_while_exception_action, *args)

    @staticmethod
    def do_until_valid(check_if_valid_action, *args):
        ...
        ScraperHelper.do_until_action(do_while_not_valid_action, *args)
